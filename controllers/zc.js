...
const jdCookieNode = ['pt_key=AAJhieYAADDDkH8fy1c8dQSkEQrwPpHHBR8_sNhZ1sjNOPwjHh7f0Hgp-m8N7TeuwYHF1Uf72OY;pt_pin=jd_EjuhMfYfqMYD;'];
let allMessage = '';
let allMessage2 = '';
...
async function showMsg() {
    ...
    console.log(`gujianwen${ReturnMessage}`)
	if ($.isNode() && WP_APP_TOKEN_ONE) {
		if (TempBaipiao) {
